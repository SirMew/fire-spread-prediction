...
o.e_dB_f         = 10*np.log10(P_f/(P_b+P_o))
o.e_dB_b         = 10*np.log10(P_b/(P_f+P_o))
o.e_dB_o         = 10*np.log10(P_o/(P_f+P_b))
...
if ~isfinite(surprisal) || ~isreal(surprisal): #if surprisal is infinite or not a real number
    print('SURPRISE: A surprising error was encountered while computing the surprisal.')
